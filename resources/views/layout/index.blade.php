	...
	<div class="side-nav-panel-right">
		<ul id="slide-out-right" class="side-nav side-nav-panel collapsible">
			<li class="profil">
				...
				<h2>请登录...</h2>
				@else
				<img src="/index/img/Demo.jpg" alt="">
				<h2>{{session('username')}}</h2>
				@endif
			</li>
			<li><a href="setting.html"><i class="fa fa-cog"></i>设置</a></li>
			<li><a href="about-us.html"><i class="fa fa-user"></i>关于我们</a></li>
			<li><a href="{{url('home/loginout')}}"><i class="fa fa-envelope-o"></i>退出</a></li>
			<li><a href="{{url('home/login')}}"><i class="fa fa-sign-in"></i>登录</a></li>
			<li><a href="{{url('home/register')}}"><i class="fa fa-user-plus"></i>注册</a></li>
		</ul>
	</div>
	<!-- end side nav right-->
		...
		<div class="modal-content">
			<div class="cart-menu">
				<div class="container">
					...
					<button class="btn button-default">前往结算</button>
				</div>
			</div>
		</div>
	</div>
